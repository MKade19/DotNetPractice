...
class InputOutput {
    ...
    /// </returns>
    public static string? TimeoutInput(int interval, string caption = "Enter word: ", int minLength = -1, int maxLength = Int32.MaxValue){
    ...
    public static string? WordInput(string caption = "Enter word: ", int minLength = -1, int maxLength = Int32.MaxValue) {
        string? word;
    ...
    public static int NumberInput(string caption = "Enter number: ") {
        int number;
    ...
    public static void RoundInfo(int roundNumber) {
